...
# get paramaters from AWS Parameter store
ssm = boto3.client('ssm')
response = ssm.get_parameter(Name='/clarusway/ferhan/password')
pw = response['Parameter']['Value']
response = ssm.get_parameter(Name='/clarusway/ferhan/endpoint')
